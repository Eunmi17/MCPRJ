...
<%
	...
	String[] addr = mntninfopoflc.text().split(" ");
			...
			<div class="content">
				<div class="container-fluid">
					...
					<div id="api">
						...
						산코드 : <%=TextUtil.exchangeEscapeNvl(id[i]) %>
						<br>
						산명 : <%=TextUtil.exchangeEscapeNvl(name[i]) %>
						<br>
						소재지 : <%=TextUtil.exchangeEscapeNvl(addr[i]) %>
						<br>
						높이 : <%=TextUtil.exchangeEscapeNvl(h[i]) %>
						<br>
						<%} %>
					</div>
					<div>
