					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<form method="post" action="/teamI_proc.do">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label class="bmd-label-floating">동호회 명</label>
													<input type="text" name="team_name" class="form-control" readonly value="<%=CmmUtil.nvl(mDTO.getTeam_name())%>">
													<input type="hidden" name="team_no" value="<%=CmmUtil.nvl(mDTO.getTeam_no())%>">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label class="bmd-label-floating">가입 인사</label>
													<textarea name="join_memo" class="form-control" rows="10" placeholder="잘부탁드립니다."></textarea>
													<input type="hidden" name="join_form" value="<%=CmmUtil.nvl(mDTO.getJoin_form())%>">
												</div>
											</div>
										</div>
